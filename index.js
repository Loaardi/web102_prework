...
function filterFundedOnly() {
    ...
    console.log(fundedGames.length); // To see the count for secret key
...
const totalRaisedContribution = GAMES_JSON.reduce((total, game) => total + game.pledged, 0);
const totalGames = GAMES_JSON.length;

const descriptionText = `A total of $${totalRaisedContribution.toLocaleString()} has been raised for ${totalGames} games.
...
descriptionContainer.append(descriptionP);
